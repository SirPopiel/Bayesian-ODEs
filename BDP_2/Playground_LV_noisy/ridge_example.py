...
##########################################################################################################################
    ...
    #     q = (np.sum(-V**2) - loggamma_v**2 - loglambda_v**2)/(2.0 * mom)
    #     return q
    ...
    mom_lambda = 0.05  # Momentum for the Hamiltonian Monte Carlo for lambda parameters  0.001
    mom_gamma = 0.15  # Momentum for the Hamiltonian Monte Carlo for gamma parameters  0.01
    L = 40  # leap frog step number
    epsilon = 0.002  # leap frog step size  0.001
    ...
    w_means = np.array([0, 0, 0, 0], dtype=np.float32)  # A priori means of parameters of the model
    w_means = w_means.reshape(4, 1)
