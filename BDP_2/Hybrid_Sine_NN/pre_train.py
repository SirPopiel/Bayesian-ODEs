...
if __name__ == "__main__":
    ...
    z0 = [-1.193, -3.876]
    true_y0 = tf.cast([[-1.193, -3.876]], dtype=tf.float32)
    ...
    true_y0 = tf.cast([[-1.193/sigma_normal1, -3.876/sigma_normal2]], dtype=tf.float32)
    ...
    class ODEModel_pre(tf.keras.Model):
        def __init__(self):
            ...
            self.Weights = tf.Variable(tf.random.normal([num_param + num_param_NN, 1], dtype=tf.float32)*0.01, dtype=tf.float32)
