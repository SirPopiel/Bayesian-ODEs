...
def get_data(path = '../Data/COVID-19.RData', country_code = 'IT', start_date = '2020-02-24', end_date = '2020-12-25', source = 'JHU', model = 'SIRD', rdata = True):
    ...
    if rdata:
        ...
        contagio = pd.read_csv(path + country_code + '.csv')
